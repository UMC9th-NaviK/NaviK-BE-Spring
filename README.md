...
| <small>- OAuth 인증 처리<br/>- 성장 로그 분석 서버 담당<br/>- 비동기 워커 패턴 설계</small>                        | <small>- AWS 인프라 및 CI/CD 구축, <br/>- 성장 로그 담당 <br/>- 비동기 워커 패턴 설계</small>                   | <small>(Lead) <br/>- 채용 공고 추출 및 추천 <br/>- 모니터링 환경 설정</small>                               | <small>- FastAPI 이력서 분석 서버 담당<br/>- Few-Shot Prompt 활용 및 일치율 개선</small>                     | <small>- 소셜 관련 기능 담당 <br/>- 병목 지점 Redis 캐싱 및 카운트 원자적 처리</small>                             |                                                                          

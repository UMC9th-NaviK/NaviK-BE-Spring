	...
	public LLMResponseDTO.Recruitment getRecruitment(String text) {
		...
		SystemMessage systemMessage = SystemMessage.builder()
			.text("""
				 ...
				 [지시]
				 1. 우선 OCR 내용을 구조화하세요.
				 2. 직무 명이 중복되지 않도록 정리하세요.
				 3. '프로덕트 매니저', '프로덕트 디자이너', '프론트엔드 개발자', '백엔드 개발자'로 분류 가능한 직무만 남기세요.
				 ...
				 - 전공은 맥락 상 필수 요건인 경우에만 majorType으로 출력한다. 필수가 아니라면 null로 출력한다.
				 - 정보가 없는 경우 null로 출력한다.
				 ...
				 - majorType: IT, 디자인/미디어, 자연/과학/바이오, 공학, 인문/사회/교육, 경영/경제/사무
				""")
			.build();

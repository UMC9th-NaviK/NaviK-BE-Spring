package navik.domain.growthLog.notion.repository;
...
public class NotionTokenRepository {
	 ...
	 */
	public void save(Long userId, NotionWorkspaceToken token) {
		try {
	 ...
	 * 특정 워크스페이스 토큰 조회
	 */
	public Optional<NotionWorkspaceToken> findByUserIdAndWorkspaceId(Long userId, String workspaceId) {
	 ...
	 * 특정 워크스페이스 토큰 삭제
	 */
	public void deleteByUserIdAndWorkspaceId(Long userId, String workspaceId) {
